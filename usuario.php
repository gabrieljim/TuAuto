...
/*function tomar(){
  ...
  var valor = obtenerValorParametro('actualizo');
...
var valor2 = obtenerValorParametro('creado');
...
function confirma(usu,ac){
	...
	document.getElementById('sta').value=2;	
                            ...
                            <?php include "usuario/consultas_generales.php"?>                                                          
                              <select class="form-control" id="es" name="es" onchange="showselect5(this.value)">
                                     ...
                                     <?php include "usuario/estados.php"?>
                                        ...
                                        <!--<div class="form-group" style="font-size: 18px;">
                                            <label>Pais en el que publicará</label>
                                            <div class="checkbox">
                                                <label>
                                                    <input style="font-size: 18px; width: 18px; height: 18px;" type="checkbox" value="">Argentina
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input style="font-size: 18px; width: 18px; height: 18px;" type="checkbox"  value="">Chile
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input style="font-size: 18px; width: 18px; height: 18px;" type="checkbox" value="">Uruguay
                                                </label>
                                            </div>
                                        </div>-->
...
<button type="button"  class="btn btn-danger btn-lg btn-block"  data-toggle="modal"
                data-target="#miModal_desactivar">Desactivar Usuario</button>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <!--Para cuando los datos han sido actualizados-->

       

        <!--<p id="actualizado" style="display: none">Sus datos han sido actualizados exitosamente</p>-->

        

        <!--Para cuando el usuario ha sido creado exitosamente-->

       

        <!--<p id="creado" style="display: none">Se ha creado el usuario exitosamente</p>-->

        

        <!--Cuando se va a desactivar a un usuario-->
            ...
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-12" style="font-size: 14px">
                        <p id="si" style="display: none">¿ESTÁ SEGURO QUE DESEA DESACTIVAR ESTE USUARIO?</p>
                        <p id="no" style="display: none">¿DESEAS ACTIVAR ESTE USUARIO?</p>
                    </div>
                    <div class="col-md-6">
                        <form name="cerrar" action="usuario/cerrarCuenta.php?ad=1" method="POST">
                    ...
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-no" onClick="$('#aviso').modal('hide');">No</button>
                    </div>
                </div>
            </div>-->
